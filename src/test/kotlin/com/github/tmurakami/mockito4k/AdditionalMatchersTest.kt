...
class AdditionalMatchersTest {
    ...
    @Test
    fun `and should make a matcher that matches both of the given matchers`() {
    ...
    @Test
    fun `or should make a matcher that matcher either of the given matchers`() {
        val mock = Mockito.mock(I::class.java)
        mock.f("b")
    ...
    @Test
    fun `not should make a matcher that does not match the given matcher`() {
        val mock = Mockito.mock(I::class.java)
        mock.f("b")
